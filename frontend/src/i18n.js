...
const ZH = {
  ...
  navForecast: "周常总表",
  checkinTitle: "登记今晚职业",
  checkinHint: "核心与特化都是独立职业，选一个即可。同一人可提交多条不同组合。虚线为即将推出的特化。",
  nickname: "公会昵称",
  nickPlaceholder: "例如：影织者",
  rallyDate: "集会日期",
  confirm: "确认出席",
...
const EN = {
  ...
  checkinHint: "Core and elite specs are separate choices. You may submit multiple profession + role combos. Dashed border = upcoming spec.",
  ...
  needNick: "Please enter a guild nickname",
  savedCheckin: "Saved. You can add another profession or role.",
  armorAll: "Professions",
  armorHeavy: "Heavy · Soldier",
  armorMedium: "Medium · Adventurer",
  armorLight: "Light · Scholar",
